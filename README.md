...
원장 - 
1.  강의 목록 -> 1. 최신순으로 정렬  /  1순위 
          ?? 선생에서 전체강의보기는 잘됨. 원장만 안됨 ;  // 완료
          
2.  학생 그래프 크기 보기 // 1순위   ??   뭐징.. 왜적어놨지ㅠ
3. 유저정보 수정 버그 // 완료 


- 게시판 - 
4. 게시판그룹 추가 후 게시판 추가가 안됨  // 완료
5. 게시글쓰기  BOLD 이후 계속 유지됨 // 안될거같음 ㅠ
6. 수정버튼 이후 등록하기가 안됨  // 완료
7. 임시저장에서 나가기 안됨 //완료 
8. 강사등록 비밀번호 암호화 / 완료
